...
import PlaidLinnk from "./PlaidLink";
        ...
        <section className="auth-form">
            <header className="flex flex-col gap-5 md:gap-8">
                <Link href={'/'} className="cursor-pointer items-center gap-1 flex">
                    <Image
                        ...
                        alt="DeBank Logo"
                    />
                    <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">DeBank</h1>
                </Link>
            ...
            {user ? (
                <div className="flex flex-col gap-4">
                    <PlaidLinnk user={user} variant="primary" />
                </div>
            ):(
                <>
                    <Form {...form}>
                            ...
                            {type === 'sign-up' && (
                                <>
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput control={form.control} name="lastName" label="Last tName" placeholder="Enter your last name" />
                                    </div>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <CustomInput control={form.control} name="postalCode" label="Postal Code" placeholder="Example: 12001" />
                                    </div>
                                    <div className="flex gap-4">
